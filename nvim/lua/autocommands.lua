...
local function open_diagnostics_in_trouble_loclist()
...
vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(event)
        ...
        vim.keymap.set("n", "gq", open_diagnostics_in_trouble_loclist, Utils.extend_opts(opts, {
            desc = "Diagnostics in Trouble loclist",
        }))
